...
foreach(_cmake_expected_target IN ITEMS MPG123::FLAC MPG123::libmpg123 MPG123::libsyn123)
...
# Create imported target MPG123::FLAC
add_library(MPG123::FLAC SHARED IMPORTED)

set_target_properties(MPG123::FLAC PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "\$<\$<NOT:\$<BOOL:ON>>:FLAC__NO_DLL>"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "\$<\$<BOOL:>:m>;ogg"
)
