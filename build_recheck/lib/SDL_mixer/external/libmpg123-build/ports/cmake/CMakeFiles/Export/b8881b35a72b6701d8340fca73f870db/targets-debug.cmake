...
# Import target "MPG123::FLAC" for configuration "Debug"
set_property(TARGET MPG123::FLAC APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(MPG123::FLAC PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/FLAC.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/FLAC.dll"
  )
...
set_target_properties(MPG123::libmpg123 PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/mpg123.dll"
  )
...
set_target_properties(MPG123::libsyn123 PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/bin/syn123.dll"
  )
