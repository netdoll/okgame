...
//#else
//
//sce::SampleUtil::Graphics::FontLoader* BobFont::m_fontLoader = nullptr;
//
//
//sce::SampleUtil::Graphics::Font* BobFont::ttf_6 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_7 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_8 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_9 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_10 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_11 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_12 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_13 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_14 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_15 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_16 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_17 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_18 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_19 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_20 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_21 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_22 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_23 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_24 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_25 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_26 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_27 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_28 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_29 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_30 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_31 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_32 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_48 = nullptr;
//sce::SampleUtil::Graphics::Font* BobFont::ttf_64 = nullptr;
//
//
//#endif
...
//#else
//	m_fontLoader = Main::getMain()->getBaseService()->m_resourceManager.m_fontLoader;
//
//	int ret = ssg::createFontLoader(&Main::getMain()->getBaseService()->m_resourceManager.m_fontLoader, Main::getMain()->getGraphicsContext());
...
//	{
//
//		sce::SampleUtil::Graphics::Font** f = nullptr;
//
//		if (i == 0)f = &ttf_6;
//		if (i == 1)f = &ttf_7;
//		if (i == 2)f = &ttf_8;
...
//		fontParam.weight = ssg::kFontWeightNormal;
//		fontParam.fontSizePixelH = GLUtils::getMonitorHeight() * ((i*0.01) + 0.06);
//		fontParam.fontSizePixelV = GLUtils::getMonitorHeight() * ((i*0.01) + 0.06);
//		ret = m_fontLoader->createFont(f, &fontParam, 64);
//		SCE_SAMPLE_UTIL_ASSERT_EQUAL(ret, SCE_OK);
//	}
//
//
...
//#endif
	...
	log.debug("Load fonts took " + to_string((double)((now - start) * 1000) / System::GetPerformanceFrequency()) + "ms");
	start = System::getPerformanceCounter();
	...
	now = System::getPerformanceCounter();
	log.debug("Load bitmap fonts took " + to_string((double)((now - start) * 1000) / System::GetPerformanceFrequency()) + "ms");
	start = System::getPerformanceCounter();


	totalNow = System::getPerformanceCounter();
	log.debug("Init fonts took " + to_string((double)((totalNow - totalStart) * 1000) / System::GetPerformanceFrequency()) + "ms");
