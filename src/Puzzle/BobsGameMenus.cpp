...
{//=========================================================================================================================
	...
	{
		if (!textStarted) { Main::StartTextInput(); getControlsManager()->text = userNameText; textStarted = true; }
	...
	{
		if (!textStarted) { Main::StartTextInput(); getControlsManager()->text = emailText; textStarted = true; }
	...
	{
		if (!textStarted) { Main::StartTextInput(); getControlsManager()->text = confirmPasswordText; textStarted = true; }
...
{//=========================================================================================================================
	...
	{
		if (!textStarted) { Main::StartTextInput(); getControlsManager()->text = saveRoomConfigNameText; textStarted = true; }
