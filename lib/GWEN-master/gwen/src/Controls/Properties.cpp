...
bool Properties::OnMouseWheeled(int iDelta)
{
...
GWEN_CONTROL_CONSTRUCTOR( PropertyRow )
{
	...
	pLabel->SetTextColor(Gwen::Color(0, 0, 0, 255));
	//SetHeight(24);
	//SetAlignment(Pos::Left | Pos::CenterV);
...
bool PropertyRow::OnMouseWheeled(int iDelta)
{
	//std::cout << "proprow" << std::endl;
	return GetParent()->OnMouseWheeled(iDelta);
}
